...
shapes = [S, Z, I, O, J, L, T]
shape_colors = [(255, 20, 20), (255, 100, 0), (0, 240, 255), (251, 255, 10), (205, 0, 255), (0, 0, 255), (0, 255, 0)]
...
def draw_next_shape(shape, surface):
    ...
    sy = top_left_y + play_height/2 - 125
    format = shape.shape[shape.rotation % len(shape.shape)]
...
def main():
    ...
    draw_text_middle("You Lost", 100, (255,0,0), win)
    pygame.display.update()
